  ...
  return (
    <div className="min-h-screen bg-[#0c0504] text-[#e0c9a6] relative overflow-y-auto overflow-x-hidden flex flex-col items-center pb-10">
      ...
      <header className="w-full pt-12 pb-6 text-center z-10 relative">
          ...
          <p className="text-[#8d6e63] font-serif italic mt-3 text-sm tracking-widest">Sabedoria Eterna</p>
      </header>
      <div className="w-full max-w-lg px-6 flex flex-col gap-4 z-10">
          <GlassButton 
             ...
             desc="Palavra de Deus para sua vida"
          ...
          <GlassButton 
             ...
             label="📚 Biblioteca"
             desc="Livros e autores cristãos"
          ...
          <GlassButton 
             ...
             desc="Reflexão diária para sua alma"
          ...
          <GlassButton 
             ...
             desc="Cânticos de adoração e fé"
          ...
          <GlassButton 
             ...
             desc="Crescimento espiritual profundo"
          ...
          <GlassButton 
             ...
             label="🧩 Quiz Bíblico"
             desc="Desafie seu conhecimento bíblico"
          ...
          <GlassButton 
             ...
             icon={<Search size={28} />}
             label="🔍 Dicionário"
             desc="Significado de termos sagrados"
          ...
          <GlassButton 
             ...
             desc="Tire suas dúvidas com a IA"
          ...
          <GlassButton 
             ...
             label="💬 Comunidade"
             desc="Converse com outros irmãos"
          ...
          />
           <GlassButton 
             ...
             icon={<Radio size={28} />}
             label="📻 Rádios Online"
             desc="Sintonize louvores ao vivo"
             onClick={() => handleNav('radios')}
          />
           <GlassButton 
             index={10}
             ...
             desc="Personalize sua experiência"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm animate-in fade-in duration-300">
             <div className="relative w-full max-w-md border border-[#bf953f] shadow-[0_0_50px_rgba(191,149,63,0.3)] rounded-2xl overflow-hidden flex flex-col max-h-[90vh]">
                <div className="absolute inset-0 z-0">
                    ...
                    <img src="https://images.unsplash.com/photo-1504052434569-70ad5836ab65?q=80&w=1920&auto=format&fit=crop" alt="Fundo Cruz" className="w-full h-full object-cover object-center" />
                </div>
                        ...
                        {loadingDaily ? (
                            ...
                            <div className="space-y-8 animate-in slide-in-from-bottom-4">
                                ...
                                <div className="bg-[#bf953f]/10 backdrop-blur-sm p-6 rounded-xl border border-[#bf953f]/20">
                                    <h4 className="text-xs uppercase tracking-[0.2em] text-[#bf953f] mb-3 font-bold flex items-center justify-center gap-2"><Sparkles size={12}/> Reflexão</h4>
                                ...
                                >
                                    {isSpeaking ? <><StopCircle size={20} /> Parar Leitura</> : <><Volume2 size={20} /> Ouvir Reflexão</>}
                                </button>
                            </div>
                        ) : (
                            <p className="text-[#e0c9a6] font-serif italic">Buscando sabedoria...</p>
                        )}
                    </div>
                </div>
             </div>
